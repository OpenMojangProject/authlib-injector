# authlib-injector
[![latest release](https://img.shields.io/github/v/tag/OpenMojangProject/authlib-injector?color=yellow&include_prereleases&label=version&sort=semver&style=flat-square)](https://github.com/OpenMojangProject/authlib-injector/releases)
[![ci status](https://img.shields.io/github/actions/workflow/status/OpenMojangProject/authlib-injector/ci.yml?branch=develop)](https://github.com/OpenMojangProject/authlib-injector/actions?query=workflow%3ACI)
[![license agpl-3.0](https://img.shields.io/badge/license-AGPL--3.0-blue.svg?style=flat-square)](https://github.com/OpenMojangProject/authlib-injector/blob/develop/LICENSE)

The authlib-injector project allows you to inject a custom legacy Mojang authentication server into your Minecraft client.

## Download
You can download the latest authlib-injector build from [here](https://github.com/OpenMojangProject/authlib-injector/releases/latest). You can learn how to setup your own legacy Mojang authentication server [here](https://github.com/OpenMojangProject/Legacy-Authentication-Server).
...
## License
This work is licensed under the [GNU Affero General Public License v3.0](https://github.com/OpenMojangProject/authlib-injector/blob/develop/LICENSE) or later, with the "AUTHLIB-INJECTOR" exception.
